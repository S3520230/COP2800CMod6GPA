...
public class PalmerPenguinsM6 {
    ...
    public static void main(String[] args) {
        ...
        boolean empty = isDataEmpty(speciesData);
...
public static void countSpecies(String[] speciesData, int[] speciesCount) {
    for (String species : speciesData) {
        if (species.equals(SP_ADELIE)) {
            speciesCount[0]++;
        } else if (species.equals(SP_CHINSTRAP)) {
            speciesCount[1]++;
...
public static void printSpeciesCount(int[] speciesCount) {
    System.out.println(SP_ADELIE + ": " + speciesCount[0]);
    System.out.println(SP_CHINSTRAP + ": " + speciesCount[1]);
    System.out.println(SP_GENTOO + ": " + speciesCount[2]);
}
}
